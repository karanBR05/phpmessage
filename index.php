...
<body>
   <div class="container">
    <!-- --------------- HEADER --------------- -->
      <nav id="header">
        <div class="nav-logo">
            <p class="nav-name">Karan Kumar</p>
            <span></span>
        </div>
       ...
       <section class="featured-box" id="home">
          <div class="featured-text">
            <div class="featured-text-card">
                <span>karan kumar</span>
            </div>
            <div class="featured-name">
                <p>I'm <span developer class="typedText"></span></p>
            </div>
            ...
            <div class="featured-text-btn">
                <button class="btn blue-btn">Contact Me</button>
                </div>
            <div class="social_icons">
                <div class="icon">
                    <a href="https://www.linkedin.com/in/karankumar1903/">  <i  class="uil uil-linkedin-alt"></i></a></div>
                <div class="icon"><i class="uil uil-github-alt"></i></div>
            </div>
          </div>
          <div class="featured-image">
            <div class="image">
                <img src="IMG-2292~3.jpg" alt="avatar">
            </div>
          </div>
       ...
       <section class="section" id="projects">
          ...
          <div class="project-container">
            <div class="project-box">
                ...
                <h3>Completed</h3>
                <label>9+ Finished Projects</label>
            </div>
            <div class="project-box">
          ...
          <div class="row">
             <div class="col">
                <div class="contact-info">
                    ...
                    <p><i class="uil uil-envelope"></i> Email: karankumar.19march@gmail.com.com</p>
                    <p><i class="uil uil-phone"></i> Tel: +91 6207773977</p>
                </div>
             </div>
             <div class="col">
   ...
   <!-- <div class="input-row">
      ...
      <input type="text" name="userName"class="input-field" required id="userName"> 
    </div>
    <div class="input-row">
      <label>Email <em></em></label> 
      <input type="email" name="userEmail" class="input-field"required id="userEmail"> 
    </div>
    <div class="input-row">
      <label>Phone <em></em></label> 
      <input type="text" name="userPhone"class="input-field" required id="userPhone">
    </div>
    <div class="input-row">
    ...
    <footer>
        ...
        <div class="bottom-footer">
            <p>Copyright &copy; <a href="#home" style="text-decoration: none;">Karan Kumar</a> - All rights reserved</p>
        </div>
    </footer>
